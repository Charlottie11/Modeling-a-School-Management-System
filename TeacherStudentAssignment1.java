...
String courseName;
    ...
    static void displayCourse(Course[] courses) {
        ...
        for (int c = 0; c < courses.length; c++) {
            System.out.println("* " + courses[c].courseCode + "-" + courses[c].courseName);
        }
    }
}
class TeacherStudentAssignment1 {
    public static void main(String[] args) {
        Student.students[0] = new Student("Charlie Agustin", 19, "Male", 202411418);
        Student.students[1] = new Student("Keimi Ilag", 18, "Female", 202444444);
        Student.students[2] = new Student("Jerico Quitilen", 30, "Male", 202411517);
        ...
        Course[] t1Courses = {course2, course3};
        Course[] t2Courses = {course4, course1, course5};
